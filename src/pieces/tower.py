"""Contains the class Tower, an important Peachess piece."""

from chessboard.chessboard import Chessboard
from piece import Piece, Color

class Tower(Piece):
    """Represents a classic Tower piece in peachess game"""

    def __init__(self, position: tuple[int, int], color: Color):
        """Initializes a Tower piece.
    ...
    def possible_moves(self, board: Chessboard) -> list[tuple[int, int]]:
        """Returns the possible moves of the Tower in the board given.
